...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-10 md:p-24">
      ...
      {
        toggle === 'tech' ?
        <div className="text-2xl hover:bg-gray-100 p-5 px-8 hover:border-[1px] rounded">
          <div className="flex text-center text-2xl flex-col gap-y-4">
            <Label>Next JS</Label>
            <Label>Clerk</Label>
